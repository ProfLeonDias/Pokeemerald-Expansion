...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_ACE_COUPLE,
    TRAINER_PIC_FRONT_ACE_TRAINER_M,
    TRAINER_PIC_FRONT_ACE_TRAINER_F,
    TRAINER_PIC_FRONT_BIKER,
    TRAINER_PIC_FRONT_BURGLAR,
    TRAINER_PIC_FRONT_CHANNELER,
    TRAINER_PIC_FRONT_CRUSH_KIN,
    TRAINER_PIC_FRONT_CUE_BALL,
    ...
    TRAINER_PIC_FRONT_ALEX,
    TRAINER_PIC_FRONT_RED_USUM,
    TRAINER_PIC_FRONT_BLUE_USUM,
    TRAINER_PIC_FRONT_LANCE,
    TRAINER_PIC_FRONT_STEVEN_ORAS,
    TRAINER_PIC_FRONT_CYNTHIA,
    TRAINER_PIC_FRONT_COLRESS,
    TRAINER_PIC_FRONT_IRIS,
    TRAINER_PIC_FRONT_DIANTHA,
    TRAINER_PIC_FRONT_LEON,
    TRAINER_PIC_FRONT_NEMONA,
    ...
    TRAINER_PIC_BACK_ALEX,
    TRAINER_PIC_BACK_LYON,
    TRAINER_PIC_BACK_KATELYN,
    TRAINER_PIC_BACK_ZAPH,
    TRAINER_PIC_BACK_FIA,
    TRAINER_PIC_COUNT,
