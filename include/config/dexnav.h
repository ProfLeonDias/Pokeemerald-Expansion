...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x3A // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x3B // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x3C // Allow player to find hidden mons
