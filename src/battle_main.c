...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("{PKMN} Trainer"), 15 },
    [TRAINER_CLASS_HIKER] =          { _("Hiker"), 10 },
    [TRAINER_CLASS_TEAM_AQUA] =      { _("Team Aqua"), 8 },
    [TRAINER_CLASS_PKMN_BREEDER] =   { _("{PKMN} Breeder"), 7, BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] =    { _("Ace Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] =    { _("Bird Keeper"), 6, BALL_NEST },
    [TRAINER_CLASS_COLLECTOR] =      { _("Collector"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] =      { _("Swimmer♂"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] =     { _("Black Star"), 8 },
    [TRAINER_CLASS_EXPERT] =         { _("Expert"), 10, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_ADMIN] =     { _("High Cultist"), 15 },
    [TRAINER_CLASS_BLACK_BELT] =     { _("Black Belt"), 6, BALL_GREAT },
    [TRAINER_CLASS_AQUA_LEADER] =    { _("Cult Leader"), 25, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] =     { _("Hex Maniac"), 6, BALL_DUSK },
    [TRAINER_CLASS_AROMA_LADY] =     { _("Aroma Lady"), 7, BALL_FRIEND },
    [TRAINER_CLASS_RUIN_MANIAC] =    { _("Ruin Maniac"), 12, BALL_TIMER },
    [TRAINER_CLASS_INTERVIEWER] =    { _("Interviewer"), 15 },
    [TRAINER_CLASS_TUBER_F] =        { _("Tuber"), 1 },
    [TRAINER_CLASS_TUBER_M] =        { _("Tuber"), 1 },
    [TRAINER_CLASS_LADY] =           { _("Lady"), 50, BALL_LUXURY },
    [TRAINER_CLASS_BEAUTY] =         { _("Beauty"), 18, BALL_LOVE },
    ...
    [TRAINER_CLASS_POKEFAN] =        { _("Pokéfan"), 20, BALL_LOVE },
    [TRAINER_CLASS_YOUNGSTER] =      { _("Youngster"), 4 },
    [TRAINER_CLASS_CHAMPION] =       { _("Champion"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] =      { _("Fisherman"), 9, BALL_LURE },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] =  { _("Ace Trainer"), 9, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] =    { _("High Cultist"), 15 },
    [TRAINER_CLASS_RIVAL] =          { _("{PKMN} Trainer"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] =    { _("Bug Catcher"), 3 },
    [TRAINER_CLASS_PKMN_RANGER] =    { _("{PKMN} Ranger"), 9 },
    [TRAINER_CLASS_MAGMA_LEADER] =   { _("Cult Leader"), 25, BALL_MASTER },
    [TRAINER_CLASS_LASS] =           { _("Lass"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] =   { _("Young Couple"), 7, BALL_LOVE },
    ...
    [TRAINER_CLASS_DOME_ACE] =       { _("Dome Ace"), 0, BALL_ULTRA},
    [TRAINER_CLASS_PALACE_MAVEN] =   { _("Palace Maven"), 0, BALL_ULTRA },
    [TRAINER_CLASS_ARENA_TYCOON] =   { _("Arena Tycoon"), 0, BALL_ULTRA },
    [TRAINER_CLASS_FACTORY_HEAD] =   { _("Factory Head"), 0, BALL_ULTRA },
    [TRAINER_CLASS_PIKE_QUEEN] =     { _("Pike Queen"), 0, BALL_ULTRA },
    [TRAINER_CLASS_PYRAMID_KING] =   { _("Pyramid King"), 0, BALL_ULTRA },
    [TRAINER_CLASS_RS_PROTAG] =      { _("{PKMN} Trainer"), 0 },
    [TRAINER_CLASS_ACE_COUPLE] =     { _("Ace Couple"), 6, BALL_ULTRA},
    [TRAINER_CLASS_ACE_TRAINER_M] =  { _("Ace Trainer"), 9, BALL_ULTRA },
    [TRAINER_CLASS_ACE_TRAINER_F] =  { _("Ace Trainer"), 9, BALL_ULTRA },
    ...
    [TRAINER_CLASS_ENGINEER] =       { _("Worker"), 12 },
