...
{
    [POKENAV_MENUITEM_MAP]                     = COMPOUND_STRING("Check the map of the Nexar region"),
    ...
    [POKENAV_MENUITEM_SWITCH_OFF]              = COMPOUND_STRING("Put away the Pokécomm."),
    ...
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the Pokécomm menu."),
    ...
    [POKENAV_MENUITEM_CONDITION_SEARCH_CUTE]   = COMPOUND_STRING("Find cute Pokémin."),
