...
const u8 gText_DexHoennTitle[] = _("Nexar Dex");
...
const u8 gText_DexHoennDescription[] = _("Nexar region's Pokédex");
...
const u8 gText_NatureSlash[] = _("Nanture/");
...
const u8 gText_DexHoenn[] = _("Nexar");
