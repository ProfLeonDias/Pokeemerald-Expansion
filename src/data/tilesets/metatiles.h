...
const u16 gMetatiles_Wish[] = INCBIN_U16("data/tilesets/primary/wish/metatiles.bin");
const u16 gMetatileAttributes_Wish[] = INCBIN_U16("data/tilesets/primary/wish/metatile_attributes.bin");
