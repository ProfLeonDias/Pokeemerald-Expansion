...
static bool32 IsRegularLandTrainer(u8 graphicsId)
{
    ...
    u16 regularTrainersOnLand[] =
    {
        ...
        OBJ_EVENT_GFX_57_EXPERT_F,
        OBJ_EVENT_GFX_56_EXPERT_M,
        OBJ_EVENT_GFX_06_MALE_4,
        OBJ_EVENT_GFX_58_FISHERMAN,
        OBJ_EVENT_GFX_59_GENTLEMAN,
        ...
        OBJ_EVENT_GFX_LASS,
        OBJ_EVENT_GFX_01_LITTLE_BOY,
        OBJ_EVENT_GFX_02_LITTLE_GIRL,
        OBJ_EVENT_GFX_MAGMA_MEMBER_F,
        OBJ_EVENT_GFX_MAGMA_MEMBER_M,
        OBJ_EVENT_GFX_05_MALE_3,
        OBJ_EVENT_GFX_MAN_4,
        OBJ_EVENT_GFX_11_MALE_9,
        OBJ_EVENT_GFX_84_SUPER_NERD,
        OBJ_EVENT_GFX_NINJA_BOY,
        OBJ_EVENT_GFX_48_PICNICKER,
        OBJ_EVENT_GFX_73_POKEFAN_F,
        OBJ_EVENT_GFX_72_POKEFAN_M,
        OBJ_EVENT_GFX_76_PSYCHIC_M,
        OBJ_EVENT_GFX_78_RICH_BOY,
        OBJ_EVENT_GFX_91_TRIATHLETE_RUN_F,
        OBJ_EVENT_GFX_90_TRIATHLETE_RUN_M,
        OBJ_EVENT_GFX_81_SAILOR,
        OBJ_EVENT_GFX_SCHOOL_KID_M,
        OBJ_EVENT_GFX_93_TUBER_FEMALE,
        OBJ_EVENT_GFX_92_TUBER_MALE,
        OBJ_EVENT_GFX_96_TWINS,
        OBJ_EVENT_GFX_18_FEMALE_6,
...
static bool32 IsRegularWaterTrainer(u8 graphicsId)
{
    ...
    {
        OBJ_EVENT_GFX_86_SWIMMER_F,
        OBJ_EVENT_GFX_85_SWIMMER_M,
        OBJ_EVENT_GFX_94_TUBER_MALE_SWIMMING
    };
