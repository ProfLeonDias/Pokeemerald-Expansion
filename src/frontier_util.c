...
const struct FrontierBrain gFrontierBrainInfo[NUM_FRONTIER_FACILITIES] =
{
    [FRONTIER_FACILITY_TOWER] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_159_BRAIN_ANABEL,
        .isFemale = TRUE,
        .lostTexts = {
    ...
    [FRONTIER_FACILITY_DOME] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_165_BRAIN_TUCKER,
        .isFemale = FALSE,
        .lostTexts = {
            COMPOUND_STRING(
                "Grr…\n"
    ...
    [FRONTIER_FACILITY_PALACE] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_164_BRAIN_SPENSER,
        .isFemale = FALSE,
        .lostTexts = {
            COMPOUND_STRING(
                "Ah…\n"
    ...
    [FRONTIER_FACILITY_ARENA] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_161_BRAIN_GRETA,
        .isFemale = TRUE,
        .lostTexts = {
            COMPOUND_STRING(
                "No way!\n"
    ...
    [FRONTIER_FACILITY_FACTORY] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_163_BRAIN_NOLAND,
        .isFemale = FALSE,
        .lostTexts = {
            COMPOUND_STRING(
                "Good job!\n"
    ...
    [FRONTIER_FACILITY_PIKE] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_162_BRAIN_LUCY,
        .isFemale = TRUE,
        .lostTexts = {
    ...
    [FRONTIER_FACILITY_PYRAMID] =
    {
        ...
        .objEventGfx = OBJ_EVENT_GFX_160_BRAIN_BRANDON,
        .isFemale = FALSE,
        .lostTexts = {
            COMPOUND_STRING(
