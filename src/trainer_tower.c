...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_093_BEAUTY_FRLG,    FACILITY_CLASS_PARASOL_LADY,      FEMALE},
    {OBJ_EVENT_GFX_FAT_MAN_FRLG,   FACILITY_CLASS_COLLECTOR,           MALE},
    {OBJ_EVENT_GFX_158_YOUNGSTER_FRLG, FACILITY_CLASS_YOUNGSTER_FRLG,           MALE},
    {OBJ_EVENT_GFX_098_BUG_CATCHER_FRLG, FACILITY_CLASS_BUG_CATCHER_FRLG,         MALE},
    {OBJ_EVENT_GFX_120_LASS_FRLG,      FACILITY_CLASS_LASS_FRLG,              FEMALE},
    {OBJ_EVENT_GFX_136_SAILOR_FRLG,    FACILITY_CLASS_SAILOR_FRLG,              MALE},
    {OBJ_EVENT_GFX_101_CAMPER_FRLG,    FACILITY_CLASS_CAMPER_FRLG,              MALE},
    {OBJ_EVENT_GFX_102_PICNICKER_FRLG, FACILITY_CLASS_PICNICKER_FRLG,         FEMALE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_POKEMANIAC,          MALE},
    {OBJ_EVENT_GFX_SUPER_NERD,     FACILITY_CLASS_SUPER_NERD_FRLG,          MALE},
    {OBJ_EVENT_GFX_116_HIKER_FRLG,     FACILITY_CLASS_HIKER_FRLG,               MALE},
    ...
    {OBJ_EVENT_GFX_093_BEAUTY_FRLG,    FACILITY_CLASS_BEAUTY_FRLG,            FEMALE},
    ...
    {OBJ_EVENT_GFX_113_GENTLEMAN,      FACILITY_CLASS_GENTLEMAN_FRLG,           MALE},
    ...
    {OBJ_EVENT_GFX_152_TUBER_F_FRLG,   FACILITY_CLASS_TUBER_FRLG,             FEMALE},
    {OBJ_EVENT_GFX_049_FEMALE_2_FRLG,   FACILITY_CLASS_PKMN_BREEDER_FRLG,      FEMALE},
    {OBJ_EVENT_GFX_101_CAMPER_FRLG,    FACILITY_CLASS_PKMN_RANGER_M_FRLG,       MALE},
    {OBJ_EVENT_GFX_102_PICNICKER_FRLG, FACILITY_CLASS_PKMN_RANGER_F_FRLG,     FEMALE},
    {OBJ_EVENT_GFX_049_FEMALE_2_FRLG,   FACILITY_CLASS_AROMA_LADY_FRLG,        FEMALE},
    {OBJ_EVENT_GFX_116_HIKER_FRLG,     FACILITY_CLASS_RUIN_MANIAC,         MALE},
    {OBJ_EVENT_GFX_049_FEMALE_2_FRLG,   FACILITY_CLASS_LADY_FRLG,              FEMALE}
};

static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_093_BEAUTY_FRLG,    OBJ_EVENT_GFX_WOMAN_1_FRLG,   FACILITY_CLASS_SR_AND_JR,       FEMALE, FEMALE},
    ...
    {OBJ_EVENT_GFX_093_BEAUTY_FRLG,    OBJ_EVENT_GFX_MAN,            FACILITY_CLASS_YOUNG_COUPLE_FRLG,    FEMALE,   MALE},
    {OBJ_EVENT_GFX_BATTLE_GIRL,    OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_CRUSH_KIN_FRLG,       FEMALE,   MALE},
    {OBJ_EVENT_GFX_SWIMMER_F_LAND, OBJ_EVENT_GFX_151_TUBER_M_LAND,   FACILITY_CLASS_SIS_AND_BRO_FRLG,     FEMALE,   MALE}
};
...
static void SetTrainerTowerNPCGraphics(void)
{
    ...
    case CHALLENGE_TYPE_SINGLE:
        ...
        if (i != NELEMS(sSingleBattleTrainerInfo))
            ...
            trainerGfx1 = OBJ_EVENT_GFX_158_YOUNGSTER_FRLG;
    ...
    case CHALLENGE_TYPE_DOUBLE:
        ...
        {
            trainerGfx1  = OBJ_EVENT_GFX_158_YOUNGSTER_FRLG;
            trainerGfx2 = OBJ_EVENT_GFX_158_YOUNGSTER_FRLG;
        }
    ...
    case CHALLENGE_TYPE_KNOCKOUT:
        for (j = 0; j < MAX_TRAINERS_PER_FLOOR; j++)
        {
            ...
            if (i != NELEMS(sSingleBattleTrainerInfo))
                ...
                trainerGfx1 = OBJ_EVENT_GFX_158_YOUNGSTER;
