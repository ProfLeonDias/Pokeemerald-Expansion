...
bool32 SetUpFieldMove_Cut(void)
{
    ...
    if (CheckObjectGraphicsInFrontOfPlayer(OBJ_EVENT_GFX_176_CUTTABLE_TREE) == TRUE || CheckObjectGraphicsInFrontOfPlayer(OBJ_EVENT_GFX_176_CUTTABLE_TREE_FRLG) == TRUE)
    {
