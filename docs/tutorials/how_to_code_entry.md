...
```
spriteId = CreateObjectGraphicsSprite(OBJ_EVENT_GFX_084_MYSTERY_GIFT, SpriteCallbackDummy, 56, 37, 0);
```

Just swap out `OBJ_EVENT_GFX_084_MYSTERY_GIFT` for whatever event object sprite you'd like to use instead. You may need to adjust the position (the 56 and 37 in this example) depending on your sprite.
